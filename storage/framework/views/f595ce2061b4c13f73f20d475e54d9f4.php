...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/login/bootstrap.min.css')); ?>">

    <!-- icono del sistema -->
    <link href="<?php echo e(asset('images/icono-sistemalogo.png')); ?>" rel="icon">
    <!-- libreria -->
    <link href="<?php echo e(asset('plugins/fontawesome-free/css/all.min.css')); ?>" type="text/css" rel="stylesheet" />
    ...
    <style>
        ...
        body {
            ...
            background-image: url(<?php echo e(asset('images/fondo3.jpg')); ?>);
        }
                    ...
                    <div class="col-lg-6 col-12 mx-auto">
                        ...
                        <div class="p-5 bg-white rounded shadow-lg">
                            <div class="text-center image-size-small position-relative">
                                <img src="<?php echo e(asset('images/logo.png')); ?>" class=" p-2">
                            </div>
...
<script src="<?php echo e(asset('js/sweetalert2.all.min.js')); ?>" type="text/javascript"></script>
...
<?php /**PATH C:\Users\jdryn\OneDrive\Escritorio\BaseProject-main\resources\views/frontend/login/vistalogin.blade.php ENDPATH**/ ?>